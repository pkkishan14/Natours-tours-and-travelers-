...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicHJheWF0bmFrMTAiLCJhIjoiY2x4NjE4Z3JuMG1jdTJrc2NvbHg0Z3M4biJ9.daFgDjR8PXTWdcIhAwc1uw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/prayatnak10/clx63328i01yl01qrgsz2c2u3',
    scrollZoom: false
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          ...
          if (_context.t0.response) (0, _alerts.showAlert)('error', _context.t0.response.data.message);else (0, _alerts.showAlert)('error', _context.t0.message);
        case 12:
        case "end":
